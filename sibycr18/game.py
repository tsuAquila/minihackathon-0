...
print("\t\t\t*** Note that players with more ratings score more runs ***\n")
...
bowlers = {
    "fast": {"chance_of_out": 0.7, "runs_conceded": [0, 1, 2, 4, 6]},
    "medium": {"chance_of_out": 0.5, "runs_conceded": [0, 1, 2, 3, 4]},
    "slow": {"chance_of_out": 0.3, "runs_conceded": [0, 1, 1, 2, 3]}
}

# Determine the type of bowler based on random choice
bowler_type = choice(["fast", "medium", "slow"])
